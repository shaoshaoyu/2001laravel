        ...
        @csrf
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="text" name="brand_name" value="{{$brand->brand_name}}" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
            ...
            <div class="layui-form-item" style="margin-top: 50px;">
                ...
                <div class="layui-input-block">
                  <div class="layui-upload-drag" id="test10">
                    ...
                    <p>点击上传，或将文件拖拽到此处</p>
                    <div @if(!$brand->brand_log) class="layui-hide"  @endif id="uploadDemoView">
                      <hr>
                      <img src="{{$brand->brand_log}}" alt="上传成功后渲染" style="max-width: 196px">
                    </div>
                  </div>
            ...
            <!-- 隐藏域 -->
            <input type="hidden" name="brand_log"  @if($brand->brand_log) value="{{$brand->brand_log}}" @endif> 

            <div class="layui-form-item" style="margin-top: 50px;">
                <label class="layui-form-label">品牌网址</label>
                <div class="layui-input-block">
                  <input type="text" name="brand_url" value="{{$brand->brand_url}}" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
